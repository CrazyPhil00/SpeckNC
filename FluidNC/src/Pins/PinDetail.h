...
namespace Pins {
    ...
    public:
        ...
        // Add these two lines inside the PinDetail class, near the other virtual methods:
        virtual uint16_t readAnalog() { return 0; }
        virtual int16_t  readAnalogMV() { return 0; }
